...
mod test {
    ...
    use crate::{
        ...
        dither::{
            ordered::{
                algorithms::modulo_snake::generate_modulosnake, Ordered, OrderedStrategy::*,
            },
    ...
    fn dither(
        ...
        image
            ...
            .apply(&Ordered::new(
                palette.clone(),
                ScanLine(2, dither::ordered::Orientation::Horizontal),
            ))
        ...
        image
            ...
            .apply(&Ordered::new(
                palette.clone(),
                ScanLine(4, dither::ordered::Orientation::Horizontal),
            ))
        ...
        image
            ...
            .apply(&Ordered::new(
                palette.clone(),
                ScanLine(8, dither::ordered::Orientation::Horizontal),
            ))
        ...
        image
            ...
            .apply(&Ordered::new(
                palette.clone(),
                ScanLine(16, dither::ordered::Orientation::Horizontal),
            ))
            .save(format!(
        ...
        image
            ...
            .apply(&Ordered::new(
                palette.clone(),
                ScanLine(2, dither::ordered::Orientation::Vertical),
            ))
        ...
        image
            ...
            .apply(&Ordered::new(
                palette.clone(),
                ScanLine(4, dither::ordered::Orientation::Vertical),
            ))
        ...
        image
            ...
            .apply(&Ordered::new(
                palette.clone(),
                ScanLine(8, dither::ordered::Orientation::Vertical),
            ))
        ...
        image
            ...
            .apply(&Ordered::new(
                palette.clone(),
                ScanLine(16, dither::ordered::Orientation::Vertical),
            ))
        ...
        image
            ...
            .apply(&Ordered::new(
                palette.clone(),
                Wavy(dither::ordered::Orientation::Vertical),
            ))
        ...
        image
            ...
            .apply(&Ordered::new(
                palette.clone(),
                Wavy(dither::ordered::Orientation::Horizontal),
            ))
        ...
        image
            .clone()
            .apply(&Ordered::new(palette.clone(), Custom(matrix)))
